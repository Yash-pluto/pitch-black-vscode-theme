...
<div align="center">
  <img src="images/pitch-black-js.png" alt="JavaScript/React Preview" width="45%">
...
2. Search for **"Pitch Black Modern"**.
3. Click **Install**.
4. Open the Command Palette (`Ctrl+K Ctrl+T` / `Cmd+K Cmd+T`), search for **Color Theme**, and select **Pitch Black Modern**.

### Manual Installation

1. Download the latest `.vsix` package from the [Releases](#) section of the GitHub repository.
